...
vi.mock("../hooks/useLeagueList", () => ({ useLeagueList: vi.fn() }));
vi.mock("../hooks/useLeagueCountries", () => ({ useLeagueCountries: vi.fn() }));
vi.mock("../hooks/useLeagueMutation", () => ({ useLeagueMutation: vi.fn() }));
