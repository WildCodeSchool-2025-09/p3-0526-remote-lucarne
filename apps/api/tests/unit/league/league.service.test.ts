...
import { createLeague, updateLeagueOptimistic } from "../../../src/features/league/league.repository";
import { createLeagueService, updateLeagueService } from "../../../src/features/league/league.service";

vi.mock("../../../src/features/league/league.repository", () => ({
  createLeague: vi.fn(),
